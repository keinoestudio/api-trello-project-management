...
const invoiceReminder = (cardDetails) => {

    const link = `https://keinoestudio.com/permanent/templates/emails/project-started?invoice=${cardDetails.invoice}&invoiceDate=${queryfyDate(cardDetails.invoiceDate)}&promo=${cardDetails.financingPromo}`
    ...
    return `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
            ...
            <head>
                ...
                rel="preload"
                as="image"
                href="https://www.keinoestudio.com/assets/next-gen-emails/ng-financing-promo.png" />
                <link
                rel="preload"
                as="image"
                                    ...
                                    <td data-id="__react-email-column">
                                        ...
                                        <tbody style="width:100%">
                                            ...
                                            <td
                                                ...
                                                style="height:12px;background-color:#E3EE50;border-radius:8px 8px 0 0"></td>
                                            </tr>
                                        </tbody>
                                        </table>
                                        <table
                                        ...
                                        <tbody style="width:100%">
                                            ...
                                            <td
                                                ...
                                                pendiente vence pronto.
                                                </p>
                                                <p
                                                style="font-size:14px;line-height:20px;margin-top:16px;margin-bottom:16px">
                                                Enviamos este email para recordar que el
                                                plazo acordado para el abono de la
                                                ...
                                                > vence el <span style="color:#006bff"
                                                ...
                                                ${cardDetails.financingPromo ? `<table
                                                align="center"
                                                width="100%"
                                                border="0"
                                                cellpadding="0"
                                                ...
                                                <tbody style="width:100%">
                                                    ...
                                                    <td data-id="__react-email-column">
                                                        ...
                                                        src="https://www.keinoestudio.com/assets/next-gen-emails/ng-financing-promo.png"
                                                        ...
                                                        Si necesitas más margen, hay
                                                        alternativas.
                                                        </p>
                                                        <p
                                                        style="font-size:14px;line-height:20px;margin-top:16px;margin-bottom:16px">
                                                        Si en algún momento prefieres
                                                        repartir el pago en lugar de
                                                        afrontarlo de una sola vez,
                                                        podemos ayudarte. En keino
                                                        estudio<sup style="font-size:6px"
                                                            >®</sup
                                                        >
                                                        ofrecemos opciones de pago
                                                        fraccionado, sin intermediarios ni
                                                        intereses, para que la parte
                                                        económica no frene el trabajo.
                                                        </p>
                                                        <p
                                                        style="font-size:14px;line-height:24px;margin-top:16px;margin-bottom:16px">
                                                        Este sistema está disponible de
                                                        forma habitual para proyectos a
                                                        partir de 2.200 €. Aun así, en
                                                        situaciones concretas como esta
                                                        podemos ser flexibles y estudiar
                                                        una adaptación puntual.
                                                        </p>
                                                        <p
                                                        style="font-size:14px;line-height:24px;margin-top:16px;margin-bottom:16px">
                                                        Si quieres valorar esta opción,
                                                        consúltanos y vemos tu caso.
                                                        </p>
                                                    </td>
                                                    </tr>
                                                </tbody>
